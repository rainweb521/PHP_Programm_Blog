...
<body>
	...
	<p align="center"><span style="color: red">*</span>收件人：<input type="text" name="toemail" /></p>
	<p align="center"><span style="color: red">*</span>标&nbsp;&nbsp;题：<input type="text" name="title" /></p>
	<p align="center"><span style="color: red">*</span>内&nbsp;&nbsp;容：<textarea name="content" cols="50" rows="5"></textarea></p>
	<p align="center"><input type="submit" value="发送邮件"  /></p>
				...
				<div class="sidebar">
					...
					<div class="gadget">
						...
						<div class="clr"></div>
						<ul class="ex_menu">
							<?php include '../professional_menu.php'?>
						</ul>
					</div>
				</div>
				<div class="clr"></div>
